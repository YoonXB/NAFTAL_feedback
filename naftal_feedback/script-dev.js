...
// Form submission - enhanced with fallback
document.getElementById("feedbackForm").addEventListener("submit", function (e) {
  ...
  // Check if we're in development mode (file:// protocol)
  if (window.location.protocol === "file:") {
    // Redirect to development summary page
    window.location.href = "summary-dev.html"
  } else {
    // Redirect to regular summary page (with PHP backend)
